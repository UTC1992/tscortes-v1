...
@IonicPage()
@Component({
  selector: 'page-retiromedidor',
  templateUrl: 'retiromedidor.html',
})
export class RetiromedidorPage {
  ...
  onSearchInput(){
   ...
   mostrarTareaNot(item: any){
    ...
    loading.present();
    loading.dismiss();
    this.navCtrl.push('ActividadPage', {'datosActividad': item, 'Pagina':'RetiromedidorPage'});
   }
  ...
  generarGPX(){
    ...
    this.fileName='coordenadasRETIRO.gpx';
